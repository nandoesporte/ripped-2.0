...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s rippedcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  rippedcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rippedcoin transaction") + "\n" +
              "  rippedcoin-tx [options] -create [commands]   " + _("Create hex-encoded rippedcoin transaction") + "\n" +
              "\n";
