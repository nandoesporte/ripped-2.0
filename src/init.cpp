...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/rippedcoin-project/rippedcoin>";
    const std::string URL_WEBSITE = "<https://rippedcoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Rippedcoin version %s\n", FormatFullVersion());
}
