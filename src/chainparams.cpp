...
{
    const char* pszTimestamp = "BBC World 29/Mar/2021 Bitcoin surges past $68,000 for first time.";
    const CScript genesisOutputScript = CScript() << ParseHex("095770010fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1617057211, 2002886331, 0x1e0ffff0, 1, 1 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x457d216e6f6ece5e98a6cbe80f915484f1833c7fd97defad94ad7d22e210f1c5"));
        assert(genesis.hashMerkleRoot == uint256S("0x4cbd89f4d276706cebe86bf9852059d361ec0e0e68d63a0110ecca0731b90e76"));
        ...
        //vSeeds.push_back(CDNSSeedData("rippedcointools.com", "dnsseed.rippedcointools.com"));
        //vSeeds.push_back(CDNSSeedData("rippedcoinpool.org", "dnsseed.rippedcoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x457d216e6f6ece5e98a6cbe80f915484f1833c7fd97defad94ad7d22e210f1c5"))
        ...
        chainTxData = ChainTxData{
            ...
            1617057211, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1617057211, 465582, 0x1e0ffff0, 1, 1 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x31bbc73ae5d831bdebb4d8b2014c4e9da508798e206d87504ad2ef2f781d70c7"));
        assert(genesis.hashMerkleRoot == uint256S("0x4cbd89f4d276706cebe86bf9852059d361ec0e0e68d63a0110ecca0731b90e76"));
        ...
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.rippedcoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x31bbc73ae5d831bdebb4d8b2014c4e9da508798e206d87504ad2ef2f781d70c7")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1617057211, 0, 0x207fffff, 1, 1 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xfa358e96c4250d21173891ac90f8fce9f413ede925a85946861c9548c255b1f6"));
        assert(genesis.hashMerkleRoot == uint256S("0x4cbd89f4d276706cebe86bf9852059d361ec0e0e68d63a0110ecca0731b90e76"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xfa358e96c4250d21173891ac90f8fce9f413ede925a85946861c9548c255b1f6"))
        };
