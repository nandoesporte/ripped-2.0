...
{
    const char* pszTimestamp = "Mount Everest is 86 centimeter hoger dan gedacht, blijkt uit nieuwe meting 02 apr 2021";
    const CScript genesisOutputScript = CScript() << ParseHex("04678ffdc0fe5548271967f1f67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f") << OP_CHECKSIG;
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 45000;
        ...
        genesis = CreateGenesisBlock(1617403384, 2002518353, 0x1e0ffff0, 1, 1 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xd99105ef9b6f45e4e2d4add0acc18b83f0d419c944d7cf16a5a3515a982b723a"));
        assert(genesis.hashMerkleRoot == uint256S("0xcd0eb2abafe315626adac280b746db7c56d5334f038101c01c9544782a4f38a0"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xd99105ef9b6f45e4e2d4add0acc18b83f0d419c944d7cf16a5a3515a982b723a"))
        ...
        chainTxData = ChainTxData{
            ...
            1617403384, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1617403384, 693670, 0x1e0ffff0, 1, 1 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xd6c4a0a5bad9b4d2dd328c81bbd928f261c40fe5b1a20d688b2e6314616d9146"));
        assert(genesis.hashMerkleRoot == uint256S("0xcd0eb2abafe315626adac280b746db7c56d5334f038101c01c9544782a4f38a0"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xd6c4a0a5bad9b4d2dd328c81bbd928f261c40fe5b1a20d688b2e6314616d9146")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1617403384, 0, 0x207fffff, 1, 1 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xfa463ee182abda338a1e509830b96cf34173263cfce0c9a78a0de46d84d6b46d"));
        assert(genesis.hashMerkleRoot == uint256S("0xcd0eb2abafe315626adac280b746db7c56d5334f038101c01c9544782a4f38a0"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xfa463ee182abda338a1e509830b96cf34173263cfce0c9a78a0de46d84d6b46d"))
        };
